...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_DRUM_MODELS, "DRUM"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_SYSEX_PRESET_RELOAD, "SXPR"},
        {STRING_FOR_COMMUNITY_FEATURE_GRID_UNARMED_CLIP_BRIGHTNESS, "GBRI"},
        {STRING_FOR_COMMUNITY_FEATURE_DRUM_VELOCITY_LAYERS, "DVLA"},
        {STRING_FOR_VELOCITY_LAYERS, "VLAY"},
        {STRING_FOR_VELOCITY_LAYERS_CREATED, "VLAY"},
        {STRING_FOR_TOO_MANY_VELOCITY_LAYERS, "FULL"},
        ...
        {STRING_FOR_DRUM_MODEL_808_KICK, "8KIK"},
        {STRING_FOR_DRUM_MODEL_808_SNARE, "8SNR"},
        {STRING_FOR_DRUM_MODEL_HI_HAT, "HHAT"},
        {STRING_FOR_DRUM_MODEL_909_KICK, "9KIK"},
        {STRING_FOR_DRUM_MODEL_909_SNARE, "9SNR"},
        {STRING_FOR_DRUM_MODEL_HI_HAT_2, "HAT2"},
        {STRING_FOR_DRUM_TONE, "TONE"},
        {STRING_FOR_DRUM_SNAPPY, "SNAP"},
        {STRING_FOR_DRUM_NOISE, "NOIS"},
    },
    &built_in::english,
};
} // namespace deluge::l10n::built_in
